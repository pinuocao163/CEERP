...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='../data/emorynlp/emorynlp_features_roberta.pkl', help='dataset dir: emorynlp_features_roberta.pkl')

    parser.add_argument('--output_dir', type=str, default='../outputs/memorynlp/dialoguecrn_v1', help='saved model dir')

    parser.add_argument('--load_model_state_dir', type=str, default='../outputs/memorynlp/base_model/dialoguecrn_22.pkl', help='load model state dir')
    ...
    if args.cls_type.strip().lower() == 'emotion':
        ...
        class_weights = torch.FloatTensor([1 / 0.22208979, 1 / 0.10395974, 1 / 0.08449212, 1 / 0.32909548, 1 / 0.06277314, 1 / 0.07297047, 1 / 0.12461926])
    ...
    train_loader, valid_loader, test_loader = get_EmoryNLP_bert_loaders(data_path, batch_size=batch_size, classify=args.cls_type, num_workers=0)
